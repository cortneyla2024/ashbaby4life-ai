...
function Toast({ toast, onRemove }: { toast: Toast; onRemove: (id: string) => void }) {
  ...
  return (
    <div
      className={`max-w-sm w-full bg-white shadow-lg rounded-lg pointer-events-auto ring-1 ring-black ring-opacity-5 overflow-hidden ${getToastStyles()}`}
    >
      <div className="p-4">
...
// Export the Toaster component for direct use
export { Toaster as ToasterComponent, Toaster };
